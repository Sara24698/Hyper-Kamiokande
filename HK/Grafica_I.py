# -*- coding: utf-8 -*-
"""
Created on Mon Mar 11 11:21:25 2024
...
radio_tapas = 27
radio_tapas2 = 20
pos_espira_circular = np.arange(-34,35,2)
...
# rectangular loops I=1 A
	...
	w15c = wire.Wire(path=wire.Wire.CircularPath(radius=radio_cilindro, pts=20), discretization_length=0.1, current=5*I_circulares).Translate([0,0,-35.5])
	sol.AddWire(w15c)
	...
	for j in range(len(pos_espira_circular)-1):
		if j==1:
			continue
...
df.to_csv('./Caso2m_version2.csv', index = False)
