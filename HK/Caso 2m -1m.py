...
Media_superior = Tapa_superior[1]/3214
Media_inferior = Tapa_inferior[1]/3214
...
df.to_csv('/home/sara/Sara/Caso 2m-1m.csv', index = False)
...
ax.set_ylabel("Y")
ax.set_zlabel("Z")
plt.title('PMTs with excess without coil at $z = 32.5\: m$')
plt.show()
