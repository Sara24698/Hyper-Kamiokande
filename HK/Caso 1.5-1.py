...
#Parte de abajo
	...
	w3e = wire.Wire(path=wire.Wire.EllipticalPath(rx=23.5, ry=30.4, pts=20), discretization_length=0.1, current=70).Rotate(axis=(0,0,1), deg=90).Translate([0,0,-35.5]).Translate([0, 9.6,0])#I = 40
	#sol.AddWire(w3e)
